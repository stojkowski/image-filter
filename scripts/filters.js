...
$(document).ready(function() {
	...
	$("#sepia").click(function() {
		...
		for (var i = 0; i < imgPixels.data.length; i += 4) {
			...
			imgPixels.data[i + 0] = r[imgPixels.data[i + 0]];
	...
	$("#inverted").click(function() {
		...
		for (var i = 0; i < imgPixels.data.length; i += 4) {
			imgPixels.data[i + 0] = 255 - imgPixels.data[i + 0];
	...
	$("#warm").click(function() {
		...
		for (var i = 0; i < imgPixels.data.length; i += 4) {
			imgPixels.data[i + 0] = imgPixels.data[i + 0] + 8;
			imgPixels.data[i + 1] = imgPixels.data[i + 1] - 16;
			imgPixels.data[i + 2] = imgPixels.data[i + 2] - 32;
		}
...
var loadFile = function(event) {
	...
	reader.onload = function() {
		...
		var output2 = document.getElementById('original');
		output2.src = reader.result;
		document.getElementById('combo').disabled = false;
		document.getElementById('fb_share').disabled = false;
		document.getElementById('tw_share').disabled = false;
		document.getElementById('combo').innerHTML = 'Select a filter ' + '<span class="caret"></span>';
	};
	reader.readAsDataURL(event.target.files[0]);
};

function fb_share() {
	var u = document.getElementById('image').src;
	var t = '';
